...
class tweetStreamer(TwythonStreamer):
    ...
    def store_json(self):
        with open('tweet_stream_{}_{}_{}.json'.format('trump','ILI', len(collectedTweets)), 'w') as f:
...
if __name__ == '__main__':
    ...
    while(len(collectedTweets)<1000):
        ...
        try:
            #Filter by location using the latitude and longitude of southwest and north east points from the state of Illinois
            tweetCollection.statuses.filter(locations=[-89.384,37.77,-87.80,42.02])
        except:
