...
class tweetStreamer(TwythonStreamer):
    ...
    def store_json(self):
        with open('tweet_stream_{}_{}_{}.json'.format('trump','TX', len(collectedTweets)), 'w') as f:
...
if __name__ == '__main__':
    ...
    while(len(collectedTweets)<1000):
        ...
        try:
            #Filter by location using the latitude and longitude of southwest and north east points from the state of Texas
            tweetCollection.statuses.filter(locations=[-99.48,27.53,-96.69,33.01])
        except:
